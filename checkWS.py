...
def main():
	...
	ws = f.Get("dimuon_BB")
	ws.Print()
	frame = ws.var('mass_dimuon_BB').frame(ROOT.RooFit.Title(''),ROOT.RooFit.Range(800,3200))
	
	c1 = ROOT.TCanvas("c1","c1",800,600)
	#pad = ROOT.TPad("plotPad","plotPad",0,0,1,1)
	#pad.cd()
	#pad.Draw()
	ws.data("data_dimuon_BB").plotOn(frame,ROOT.RooFit.Range(800,3200))

	frame.SetMaximum(20)
	ws.pdf('bkgpdf_dimuon_BB').plotOn(frame,
								 ROOT.RooFit.Range(800,3200),
	...
	frame.Draw()
	c1.Print("signalInjected_Gauss_mass_BB.pdf")
main()
