...
class Pol9 : public RooAbsReal {
public:
  Pol9() {} ; 
  Pol9(const char *name, const char *title,
  ...
  Pol9(const Pol9& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new Pol9(*this,newname); }
  inline virtual ~Pol9() { }

protected:

  RooRealProxy x_;
  RooRealProxy p0_,p1_,p2_,p3_,p4_,p5_,p6_,p7_,p8_,p9_;

  Double_t evaluate() const ;

private:

  ClassDef(Pol9,1) // Your description goes here...
};
