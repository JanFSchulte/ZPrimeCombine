...
#include "ZPrimeMuonAccEffFuncBEneg.h"
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(ZPrimeMuonAccEffFuncBEneg) 

ZPrimeMuonAccEffFuncBEneg::ZPrimeMuonAccEffFuncBEneg(const char *name, const char *title, 
...
ZPrimeMuonAccEffFuncBEneg::ZPrimeMuonAccEffFuncBEneg(const ZPrimeMuonAccEffFuncBEneg& other, const char* name) :  
...
double power33(double x){return x*x*x;}
double power22(double x){return x*x;}
Double_t ZPrimeMuonAccEffFuncBEneg::evaluate() const 
{ 
  // ENTER EXPRESSION IN TERMS OF VARIABLE ARGUMENTS HERE 
  return effScale_*(effA_+effB_/power33(zPrimeMass_+effC_)+power22(zPrimeMass_)*effD_)*(trigA_ + trigB_*zPrimeMass_ + trigC_*zPrimeMass_*zPrimeMass_)*(std::max(0.,std::min(1.,1.003 -0.000132*zPrimeMass_-0.000000024*zPrimeMass_*zPrimeMass_))); 
} 
