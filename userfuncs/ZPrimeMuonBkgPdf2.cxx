...
#include "ZPrimeMuonBkgPdf2.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(ZPrimeMuonBkgPdf2) 

 ZPrimeMuonBkgPdf2::ZPrimeMuonBkgPdf2(const char *name, const char *title, 
                        RooAbsReal& _mass,
                        RooAbsReal& _bkg_a,
                        RooAbsReal& _bkg_b,
                        RooAbsReal& _bkg_c,
 ...
 ZPrimeMuonBkgPdf2::ZPrimeMuonBkgPdf2(const ZPrimeMuonBkgPdf2& other, const char* name) :  
 ...
 Double_t ZPrimeMuonBkgPdf2::evaluate() const 
 { 
   // ENTER EXPRESSION IN TERMS OF VARIABLE ARGUMENTS HERE 
   if (mass <= 500){
   	return exp(bkg_a2+mass*bkg_b2+mass*mass*bkg_c2)*pow(mass,bkg_e2)*(bkg_syst_a + bkg_syst_b*mass); 
   }
   else{
